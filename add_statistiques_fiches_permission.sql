...
('statistiques_fiches_view', 'Voir les statistiques fiches', 'Accès à la page Statistiques Fiches pour visualiser les fiches par centre et date (modification/insertion)', 'page', 34, 1)
