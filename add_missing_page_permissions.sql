...
SELECT * FROM permissions WHERE code IN ('suivi_agents_qualif_view', 'suivi_agents_view', 'controle_qualite_view', 'statistiques_rdv_view', 'production_qualif_view', 'signatures_view', 'fiches_detail') ORDER BY ordre;
