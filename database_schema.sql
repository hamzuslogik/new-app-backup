...
CREATE TABLE IF NOT EXISTS `fiches` (
  ...
  `id_qualite_confirmation` int(11) DEFAULT NULL COMMENT 'Agent qualité confirmation (fonction 4)',
  `observation_qualite` text DEFAULT NULL COMMENT 'Observations qualité confirmation',
  ...
  KEY `idx_fiches_id_qualite_confirmation` (`id_qualite_confirmation`),
