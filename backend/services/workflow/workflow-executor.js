 ...
 * @param {string} triggerType - Type d'événement (fiche_created, etat_changed, rdv_affecte, remarque_created, completude_created, completude_accepted, alerte_ko_created, alerte_controle_qualite_created, fiche_ko_created, decalage_refused, demande_decalage_annulee, demande_insertion_refusee, etc.)
