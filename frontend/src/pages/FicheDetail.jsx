...
function isEtatConfirmerLike(etatId, etatTitre) {
  ...
  const t = normalizeDetailItemLabel(etatTitre)
    .toLowerCase()
    .normalize('NFD')
    .replace(/[\u0300-\u036f]/g, '');
...
const FicheDetail = ({
  ...
  useEffect(() => {
    autoPdfFromQueryRef.current = false;
  }, [hash]);

  // Page pleine : ?tab=pdf → téléchargement automatique du PDF (aligné menu contextuel dashboard)
  useEffect(() => {
    if (isModal) return;
    const tab = searchParams.get('tab');
    if (tab !== 'pdf') {
    ...
    if (isLoading || !ficheData) return;
    if (autoPdfFromQueryRef.current) return;
    autoPdfFromQueryRef.current = true;
    generateFicheClientPdf(ficheData, {
            ...
            <div className="decalage-new-form" style={{ 
              ...
              {decalageFormData.nouvelle_date && (
                <div className="form-group decalage-date-preview" style={{ 
                  ...
                  {ficheData?.date_rdv_time && (
                    <div className="decalage-date-originale" style={{ 
                      marginTop: '8px', 
                      fontSize: '10.2px', 
                      color: '#666',
                      fontStyle: 'italic'
              ...
              {user.fonction === 5 && (
                <div className="form-group">
                  ...
                  {ficheData?.id_confirmateur ? (
                    <div className="decalage-readonly-value" style={{ 
                      background: '#f0f0f0', 
                      padding: '10px', 
                      borderRadius: '4px',
                      fontWeight: 'bold'
         ...
         ficheData.date_rdv_time && (
          <div className="fiche-section decalage-form" style={{ marginTop: '24px' }}>
            ...
            <div className="decalage-new-form" style={{ 
              ...
              <div className="form-group">
                <label htmlFor="select_minutes_commercial_after_state">Décalage de :</label>
                <select
                  id="select_minutes_commercial_after_state"
                  className="form-control"
                  value={decalageFormData.select_minutes}
                  onChange={(e) => {
                    const minutes = parseInt(e.target.value);
              ...
              {([1, 2, 7].includes(user.fonction)) && (
                <div className="form-group">
                  <label htmlFor="id_confirmateur_dec_commercial_after_state_select">Confirmateur :</label>
                  <select
                    id="id_confirmateur_dec_commercial_after_state_select"
                    className="form-control"
                    value={decalageFormData.id_confirmateur || (fiche?.id_confirmateur ? String(fiche.id_confirmateur) : '')}
                    onChange={(e) => {
                      setDecalageFormData({...decalageFormData, id_confirmateur: e.target.value});
              ...
              <div className="form-group">
                <label htmlFor="message_dec_commercial_after_state">Message du décalage :</label>
                <textarea
                  id="message_dec_commercial_after_state"
                  className="form-control"
                  rows="4"
                  value={decalageFormData.message}
                  onChange={(e) => {
          ...
          <div className="fiche-section decalage-form" style={{ marginTop: '24px' }}>
            ...
            <div className="decalage-new-form" style={{ 
              ...
              <div className="form-group">
                ...
                >
                  <option value="0">SANS DUREE</option>
                  <option value="10">10 MIN</option>
                  <option value="15">15 MIN</option>
                  <option value="20">20 MIN</option>
                  <option value="25">25 MIN</option>
              ...
              {!isSameDateDecalageSelection(decalageFormData.select_minutes) && decalageFormData.nouvelle_date && (
                <div className="form-group decalage-date-preview" style={{ 
                  background: '#e8f5e9', 
                  padding: '10px', 
                  borderRadius: '4px',
...
const PlanningViewForModal = ({ 
  ...
  const handleSaveDayTotal = (date) => {
    ...
    if (!canEdit || Number.isNaN(value) || value < 0) return;
    if (onUpdateAvailability) {
